...
class SessionLogger:
    ...
    def __init__(self, session_id: str = None):
        ...
        # synthesis, chart config). Emitted as a `usage` SSE event for a caller
        # that wants to show or record it. `output` includes thinking tokens
        # (thoughtsTokenCount) since Gemini bills those as output.
